...
#'
#' @name DigestiveDataSets
#' @aliases DigestiveDataSets-package
#' @title DigestiveDataSets: A Curated Collection of Digestive System and Gastrointestinal Disease Datasets
#' @description {
...
#' Useful links:
#' \itemize{
#'   \item \url{https://github.com/lightbluetitan/digestivedatasets}
#' }
#' }
#' @author {
