...
vignette: >
  %\VignetteIndexEntry{DigestiveDataSets: A Curated Collection of Digestive System and Gastrointestinal Disease Datasets}
...
```{r digestive-datasets,echo = TRUE,message = FALSE,warning = FALSE,results = 'markup'}
