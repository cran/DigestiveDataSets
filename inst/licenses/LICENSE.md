# License for `DigestiveDataSets`

This package, `DigestiveDataSets`, is licensed under the **GNU General Public License Version 3 (GPL-3)**.
...
The `DigestiveDataSets` package, including all its data files (.rda) and code files, is licensed under the GNU General Public License, version 3 or later (GPL-3).
